...
export type WorkflowEvents = onUserTokenGeneratedEvent | onPostAuthenticationEvent | onM2MTokenGeneratedEvent | onExistingPasswordProvidedEvent | onNewPasswordProvidedEvent | onUserPreMFA | onPlanSelection | onPlanCancellationRequest | onNewUsernameProvidedEvent | onUserPreRegistrationEvent;
type EventBase = {
...
export type MFAEnabledFactors = "mfa:sms" | "mfa:email" | "mfa:authenticator_app";
...
type LoginMethodParams = Partial<Pick<LoginOptions, "audience" | "scope" | "isCreateOrg" | "prompt" | "lang" | "loginHint" | "orgCode" | "orgName" | "connectionId" | "redirectURL" | "hasSuccessPage" | "workflowDeploymentId">>;
